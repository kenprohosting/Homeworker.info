...
<head>
    ...
    <title>Freelancer Registration Payment - Homeworker Connect</title>
...
<body style="background: #f4f8fb; font-family: 'Segoe UI', Arial, sans-serif; display: flex; flex-direction: column; min-height: 100vh;">
    ...
    <div class="form-container">
        <a href="freelancer_register.php" style="color: #197b88; text-decoration: none; font-weight: 500;">&larr; Back</a>
        <h2 style="text-align: center; color: #197b88; margin: 16px 0; font-size: 1.5rem;">Complete Your Registration</h2>
        <p style="text-align: center; color: #666; margin-bottom: 24px;">Pay <?= PAYMENT_CURRENCY ?> <?= FREELANCER_REGISTRATION_FEE ?> to activate your freelancer account</p>
        ...
        <button
            ...
            data-amount="<?= FREELANCER_REGISTRATION_FEE ?>"
            ...
            <span id="button-text">Pay <?= PAYMENT_CURRENCY ?> <?= FREELANCER_REGISTRATION_FEE ?> with IntaSend</span>
        ...
        <div id="debug-info" style="margin-top: 20px; padding: 10px; background: #f0f0f0; border-radius: 5px; font-size: 0.8rem; color: #666;">
            ...
            Amount: <?= FREELANCER_REGISTRATION_FEE ?> <?= PAYMENT_CURRENCY ?><br>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            try {
                ...
                intasend.on("COMPLETE", (results) => {
                    ...
                    setTimeout(() => {
                        window.location.href = "freelancer_register_callback.php?checkout_request_id=" + results.checkout_request_id;
                    }, 1000);
                });
