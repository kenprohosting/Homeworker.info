...
<body>
    <div class="container">
        ...
        <ul>
            <li>Agents must collect the following from each househelp:</li>
            <ul>
                <li>Full name</li>
                <li>Phone number</li>
                <li>Age</li>
            ...
            <li>Househelps can only be added through a verified agent account.</li>
            <li>False or misleading data submitted will result in account suspension or ban.</li>
        </ul>
        
        <h2>4. Agent Commission</h2>
        <ul>
            <li>Agents are entitled to <strong>10% commission</strong> of the agreed salary when a househelp they registered is successfully employed through the platform.</li>
            <li>Commission is <strong>only payable once</strong> per househelp/employer match.</li>
        </ul>
        <h3>Payment Process:</h3>
        <ul>
            <li>Payment will be made via <strong>M-PESA</strong> or other agreed digital wallet.</li>
            <li>Payments are issued <strong>after confirmation</strong> from both employer and househelp that employment has begun.</li>
            <li>No commission is owed if:</li>
            <ul>
                <li>The employment does not proceed.</li>
                <li>The employer hires the househelp outside of the platform to avoid commission.</li>
            </ul>
        </ul>
        ...
        <ul>
            <li>Agents must comply with Kenyan labor laws and the <strong>Employment Act (2007)</strong>.</li>
