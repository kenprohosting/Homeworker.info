...
$profile_sql = "SELECT Profile_pic FROM freelancers WHERE ID = ?";
...
if (isset($_GET['action'], $_GET['bid']) && in_array($_GET['action'], ['confirm', 'cancel'])) {
    ...
    $stmt = $conn->prepare("UPDATE bookings SET Status = ? WHERE ID = ? AND Freelancer_ID = ?");
...
<head>
    ...
    <link rel="icon" type="image/png" href="favicon.png">
    <title>Freelancer Dashboard - Homeworker Connect</title>
...
<header>
    ...
    <nav class="main-nav">
        <ul class="nav-links">
            ...
            <li><a class="nav-btn" href="freelancer_profile.php">Update Profile</a></li>
