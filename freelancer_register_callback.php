...
if ($payment_success) {
    try {
        ...
        error_log("Freelancer registration error: " . $e->getMessage());
    }
}
?>
...
<head>
    ...
    <script>
        ...
        function updateCountdown() {
            ...
            countdown--;
            if (countdown < 0) {
                window.location.href = 'freelancer_login.php';
            }
        }
    ...
    <div class="form-container">
        <?php if ($success): ?>
            ...
            <div class="success-message">
                ...
                <p style="margin: 8px 0 0 0;">Your freelancer account has been created successfully.</p>
            </div>
            <p style="color: #666; margin: 16px 0;">You can now login and start posting jobs.</p>
            <a href="freelancer_login.php" class="btn">Go to Login</a>
            <div class="countdown">
        ...
        <?php else: ?>
            ...
            <?php endforeach; ?>
            <a href="freelancer_register_payment.php" class="btn">Retry Payment</a>
            <p style="margin-top: 16px;">
                <a href="freelancer_register.php" style="color: #197b88; text-decoration: none;">← Back to Registration</a>
            </p>
        <?php endif; ?>
    </div>
